defmodule Plug.Adapters.CowboyProxy.Handler do
  @moduledoc false
  @connection Plug.Adapters.CowboyProxy.Conn
  @already_sent {:plug_conn, :sent}
  @transports [:tcp, :ssl, :proxy_protocol_tcp, :proxy_protocol_ssl]

  def init({transport, :http}, req, {plug, opts}) when transport in @transports do
