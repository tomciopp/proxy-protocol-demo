defmodule Phoenix.Endpoint.CowboyProxyHandler do
  @moduledoc """
  ...
  *NOTE*: This feature depends on the internals of Cowboy 1.0 API
  ...
  def child_spec(scheme, endpoint, config) do
    if scheme == :https || scheme == :proxy_protocol_ssl do
    ...
    dispatches = dispatches ++ [{:_, Plug.Adapters.CowboyProxy.Handler, {endpoint, []}}]
    ...
    {ref, mfa, type, timeout, kind, modules} =
      Plug.Adapters.CowboyProxy.child_spec(scheme, endpoint, [], config)
  ...
  defp default_for(Phoenix.Transports.LongPoll), do: Plug.Adapters.CowboyProxy.Handler
  defp default_for(Phoenix.Transports.WebSocket), do: Phoenix.Endpoint.CowboyProxyWebSocket
